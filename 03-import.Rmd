...
write_rds(df, "data/census_pop.rda")
...
```{r, eval = FALSE}
# あとでeval = FALSEをはずす
download.file("https://raw.githubusercontent.com/mugiyama/seminar_sociology_r/master/data/census_pop.csv", destfile = "data/census_pop.csv")
download.file("https://raw.githubusercontent.com/mugiyama/seminar_sociology_r/master/data/census_pop.xlsx", destfile = "data/census_pop.xlsx")
download.file("https://raw.githubusercontent.com/mugiyama/seminar_sociology_r/master/data/census_pop.rds", destfile = "data/census_pop.rds")
download.file("https://raw.githubusercontent.com/mugiyama/seminar_sociology_r/master/data/census_pop.sav", destfile = "data/census_pop.sav")
download.file("https://raw.githubusercontent.com/mugiyama/seminar_sociology_r/master/data/census_pop.dta", destfile = "data/census_pop.dta")
```
...
```{r, eval = FALSE}
df <- read_sav("data/census_pop.dta")
```

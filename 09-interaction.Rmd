...
$xz$のように変数同士を掛け算して作成した変数のことを**交差項 interaction term**という。$\beta_3$が、$z$の水準によって$x$の効果がどの程度変化するのかを表す係数である。この式を次のように変形してみよう。
...
## xが連続変数、zがカテゴリ変数（またはその逆）の場合 {#interaction_continuous_category}
...
## xがカテゴリ変数、zがカテゴリ変数の場合 {#interaction_category_category}
...
## xが連続変数、zが連続変数の場合（作成中）{#interaction_continuous_continuous}

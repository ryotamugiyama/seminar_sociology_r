...
$$
\frac{`r counttable$n[1]` \times 0 + `r counttable$n[2]` \times 1}{`r counttable$n[1]` + `r counttable$n[2]`} = `round(counttable$n[2] / (counttable$n[2] + counttable$n[1]), digit = 3)`
$$

同じようにして、男性の平均値は次のように計算できる。

$$
\frac{`r counttable$n[3]` \times 0 + `r counttable$n[4]` \times 1}{`r counttable$n[3]` + `r counttable$n[4]`} = `round(counttable$n[4] / (counttable$n[3] + counttable$n[4]), digit = 3)`
$$
